    ...
    function renderSingleResult(data) {
        ...
        card.innerHTML = `
            ...
            <div class="metrics-row">
                ...
                ${data.usage ? metricHtml("Tokens", data.usage.total_tokens.toLocaleString()) : ""}
            </div>
        `;
    ...
    function renderBatchResult(data) {
        ...
        card.innerHTML = `
            ...
            <div class="metrics-row">
                ...
                ${data.total_usage ? metricHtml("Total Tokens", data.total_usage.total_tokens.toLocaleString()) : ""}
